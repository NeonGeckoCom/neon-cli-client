...
from neon_cli.gui_server import start_qml_gui
from neon_cli.utils import remove_ssml
...
def do_draw_main(scr):
    ...
    if time.time() - last_full_redraw > FULL_REDRAW_FREQUENCY:
        ...
        # noise from non-curses neon_cli that get output to the
